...
int main(int argc, char *argv[])
{
	...
	char * fichier; /* Contiendra le nom du fichier à traduire */
	...
	char *tableauHexa[200]; /* Contient les ligne d'instructions en hexa (limité à 200, peut être une allocation dynamique pour plus tard) */ 
	...
	tableauHexa[ligne_utiles] = '\0'; /* Pour la fin du fichier */

	/* Ecriture dans le fichier destination */
	strtok(fichier,"/");
	strcat(resultat,strtok(NULL,"/"));
